                        ...
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    $sql_data = "SELECT sensor_read_id, sensor_sensors_id, sensor_read,TIME_FORMAT(sensor_read_timestamp, '%T')  AS read_timestamp FROM sensors_read WHERE sensor_sensors_id = 1 ORDER BY sensor_read_id DESC LIMIT 50";
